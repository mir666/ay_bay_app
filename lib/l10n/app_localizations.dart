...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'Search by month, transaction or date'**
  ...
  /// No description provided for @namePhoneCannotBeEmpty.
  ///
  /// In en, this message translates to:
  /// **'Name & Phone cannot be empty'**
  String get namePhoneCannotBeEmpty;

  /// No description provided for @downloadMonthlyPDF.
  ///
  /// In en, this message translates to:
  /// **'Download Monthly PDF'**
  String get downloadMonthlyPDF;
  ...
  /// No description provided for @hereIsThePDFFor.
  ///
  /// In en, this message translates to:
  /// **'Here is the PDF for'**
  String get hereIsThePDFFor;

  /// No description provided for @noTransactionFoundFor.
  ///
  /// In en, this message translates to:
  /// **'No transactions found for'**
  String get noTransactionFoundFor;
